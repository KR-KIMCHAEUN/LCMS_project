...
<div class="card-header p-0 nav bg-white" style="width: 1000px;">
...
<div id="mentor"></div>
 <div id="mentorList" class="table-responsive bg-white" data-toggle="lists" style="width: 1000px;"
    ...
    <button type="button" class="btn btn-primary" id="forMentor">
        멘토 되어보기
    </button>
