...
<!-- <div class="card card-body"> -->
   <div class="testList" style="margin-left:15%; margin-top:30px;">
      <div id="link1" style="cursor:pointer;">
          <div id="cotest" data-img-width="480" data-img-height="650" data-file-no="00_TEST_IMG_02" class="item">
	</div>
	</div>
	   <div id="link2" style="cursor:pointer; margin-left:5%">
          <div id="votest" data-img-width="480" data-img-height="650" data-file-no="00_TEST_IMG_01" class="item">
	</div>
	</div>
	</div>
	</div>
...
<script type="text/javascript">
	imgShow("cotest"); //함수 호출해야만 사진 나옴.
	imgShow("votest"); //함수 호출해야만 사진 나옴.
</script>
