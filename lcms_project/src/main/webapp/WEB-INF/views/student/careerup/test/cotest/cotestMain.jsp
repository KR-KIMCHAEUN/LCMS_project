...
<div class="card card-body">
   ...
   <div class="cotest">
      <div id="link1" style="cursor:pointer;">
         <div id="cotestBaro" data-img-width="400" data-img-height="400" data-file-no="00_TEST_IMG_03" class="item"></div>
      </div>   
       <div id="link2" style="cursor:pointer;">
         <div id="cotestResult" data-img-width="400" data-img-height="400" data-file-no="00_TEST_IMG_04" class="item"></div>
		</div>
	</div>
</div>
<script src='<c:url value="/resources/js/app/file/imgShow.js"/>'></script>
<script type="text/javascript">
	imgShow("cotestBaro"); //함수 호출해야만 사진 나옴.
	imgShow("cotestResult"); //함수 호출해야만 사진 나옴.
</script>
<script>
