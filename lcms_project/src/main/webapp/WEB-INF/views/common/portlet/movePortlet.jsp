                  ...
                  advanced = [
                        {
                           ...
                           h : 4,
                           portState : 1,
                           content : `<div class="potMainT" style="background-color: #3498db; color: white; padding: 10px; border-radius: 5px;">채용정보</div>
                              <button type="button" class="btn btn-white">
                                ...
                                <tr>
                                    <td><a href="${emp.emplUrl}" onclick="openNewPage(event)">${emp.titleName}</a></td> 
                                    <td>${emp.limitDate}</td> 
